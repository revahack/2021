          ...
          <div className="column large6 medium6 small12">
            ...
            <div className="column large6 medium6 small12">
              <a
                ...
                target="blank"
                className="butlink left"
              >
                Code Of Conduct
              </a>
              <br />
              <br />
              <a href="mailto:revahack@gmail.com" className="butlink left">
                Ask Questions
              </a>
              <br />
              <br />
              <NavLink to="/faqs" className="butlink left">
            ...
            <div className="column large6 medium6 small12">
              <a
                href="https://drive.google.com/file/d/1PcIV5t9GzbS7np44Dr6cfAgR651v5wNI/view?usp=sharing"
                target="blank"
                className="butlink left"
              >
                Privacy Policy
              ...
              <br />
              <a
                href="https://drive.google.com/file/d/1mz5f8GeoUSw4qkSCF-JaMZTv5TXPeuBD/view?usp=sharing"
                target="blank"
                className="butlink left"
              >
            ...
            <a href="http://instagram.com/dscreva">
              <img
                src={logo_instagram}
                className="icon left defdark"
                alt="instagram"
              />
            </a>
            <a href="https://www.youtube.com/channel/UCYHRdTN9GDqUS7rIFE1noBw?sub_confirmation=1">
              <img
                src={logo_youtube}
                className="icon left leftpadicon defdark"
                alt="youtube"
                style={{ width: "60px" }}
              />
            </a>
